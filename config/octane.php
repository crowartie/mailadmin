...
return [
    ...
    */
    ...
    'flush' => [
        // Inertia хранит общие props в singleton — между запросами его надо сбрасывать.
    ...
    */
    ...
    // Как у PHP-FPM (request_terminate_timeout): архив вложений, перенос папки, отправка с большими файлами.
