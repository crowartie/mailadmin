        ...
        <div class="dialog" style="width: 560px" @paste="onPaste">
            ...
            <template v-else>
                ...
                <p class="hint" style="margin: 0">
                    ...
                    <!-- 273: предел стоял на сервере и нигде не был описан — человек упирался
                         в отказ во время аврала, когда обращений и правда много. -->
                    Больше пяти обращений в час подряд отправить нельзя: если их много,
                    лучше описать всё в одном — так быстрее разберут.
                </p>
                <div class="dialog__actions">
