...
export const api = {
    ...
    tasks: () => request('GET', '/mail/api/tasks'),
    createTask: (data) => request('POST', '/mail/api/tasks', data),
    updateTask: (cal, uri, data) => request('PATCH', `/mail/api/tasks/${enc(cal)}/${enc(uri)}`, data),
    deleteTask: (cal, uri) => request('DELETE', `/mail/api/tasks/${enc(cal)}/${enc(uri)}`),
