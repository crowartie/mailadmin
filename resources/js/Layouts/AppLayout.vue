...
<template>
    <div class="app">
        <aside class="rail" aria-label="Сервисы">
            ...
            <a class="rail__item" href="/" title="Почта"><Icon name="mail" /></a>
            <a class="rail__item" href="/" title="Календарь"><Icon name="cal" /></a>
            <a class="rail__item" href="/" title="Контакты"><Icon name="users" /></a>
