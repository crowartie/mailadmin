...
class CloudController extends Controller
{
    ...
    public function cloudSave(Request $request): RedirectResponse
    {
        $data = $request->validate([
            ...
            'personal_quota_gb' => ['nullable', 'numeric', 'min:0.1', 'max:10000'], 'personal_total_gb' => ['nullable', 'numeric', 'min:0', 'max:100000'], 'personal_file_days' => ['nullable', 'integer', 'min:0', 'max:3650'], 'personal_pin_gb' => ['nullable', 'numeric', 'min:0', 'max:10000'], 'personal_link_days' => ['nullable', 'integer', 'min:0', 'max:3650'],
        ...
        AppSetting::put('cloud', ['enabled' => (bool) ($data['enabled'] ?? false), 'folder' => trim($data['folder'], '/'), 'threshold_mb' => $data['threshold_mb'], 'expire_days' => $data['expire_days'], 'link_password' => (string) ($data['link_password'] ?? ''),
            ...
            'personal_quota_gb' => (float) ($data['personal_quota_gb'] ?? 15), 'personal_total_gb' => (float) ($data['personal_total_gb'] ?? 100), 'personal_file_days' => (int) ($data['personal_file_days'] ?? 28), 'personal_pin_gb' => (float) ($data['personal_pin_gb'] ?? 5), 'personal_link_days' => (int) ($data['personal_link_days'] ?? 30),
